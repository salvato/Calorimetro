...
/********************************************************************/
void 
CStarWarsCtrl::PreSubclassWindow() {
	CClientDC dc(this);
...
/********************************************************************/
void 
CStarWarsCtrl::OnSize(UINT nType, int cx, int cy) {
...
/********************************************************************/
void 
CStarWarsCtrl::OnTimer(UINT nIDEvent) {
	if (nIDEvent == 1)
		InvalidateCtrl();
...
/********************************************************************/
void 
CStarWarsCtrl::DoScrollText(CDC *pDC) {
	int nPosX =0;
	int nPosY =0;
...
/********************************************************************/
void 
CStarWarsCtrl::SetScrollSpeed(int nSpeed){
...
/********************************************************************/
void 
CStarWarsCtrl::SetStarSpeed(int nSpeed) {
...
/********************************************************************/
void 
CStarWarsCtrl::AddTextLine(LPCTSTR lpszText) {
